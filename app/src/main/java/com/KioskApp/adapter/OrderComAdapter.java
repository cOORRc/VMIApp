...
public class OrderComAdapter extends RecyclerView.Adapter<OrderComAdapter.orderAdapterViewHolder>{
	...
	public OrderComAdapter(Context context, ArrayList<DataIMCSet> orderList){
