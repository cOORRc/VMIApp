...
public class UsageSNPSetActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener,
    ...
    /* variables SharedPre */
    private String usage_set_snp_sp_tx_username, usage_set_snp_sp_tx_project_name, usage_set_snp_sp_tx_bom, usage_set_snp_sp_tx_cus;

    /* Request to connect server for get json */
    private RequestQueue SetSnpQueue;
    /* variables set json data */
    private String str_ps_t_sku_code_abt, usage_set_snp_sp_tx_part_usage, usage_set_snp_sp_tx_stock_vmi, usage_set_snp_sp_tx_part_pack;
    ...
    private RecyclerView usageSNPSet_rv_itemMenu;
    private ArrayList<DataSNPSet> usageSNPList;
    private SNPOrderAdapter snpAdapter;

    /* set recyclerView stock*/
    private RecyclerView alert_us_set_rv_itemMenu;
    ...
    private void init_snpSet() {
        ...
        usageSNPSet_tv_title_cus_service.setTextSize(32);
...
///
    ...
    /* call api to set part number on recyclerView*/
