...
public class SpecialOrderSNPSetActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener,
    ...
    /*variables json data*/
    private String ord_set_snp_sp_tx_unit_type, ord_set_snp_sp_tx_fg_code_set_abt, ord_set_snp_sp_tx_ship_type;
    ...
    private void init_snpSet() {
        ...
        speOrdSNPSet_tv_title_cus_service.setTextSize(32);
    ...
    private void getPartNumber() {
        String urlOrderSet = "https://lac-apps.albatrossthai.com/api/VMI/php/Master_Data/Part_fgCodeCus.php";
    ...
    public void onItemClick(final int position, String str_partNumber, final String str_snp, String str_ship) {
        ...
        api_alert(str_partNumber, str_snp, str_ship);
...
//					alert_data_customerBOX.setText(data_minus);
        ...
        alert_bt_cart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                /* if push "yes" it will save order */
    ...
    private void api_alert(String str_partNumber, String str_snp, String str_ship) {
