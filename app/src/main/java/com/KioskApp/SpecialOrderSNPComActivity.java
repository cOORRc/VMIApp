...
/*set ui*/
    private void init_snpCom() {
        ...
        speOrdSNPCom_tv_title_cus_service.setTextSize(32);
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    for (int i = 0; i < ja_snpResultComData.length(); i++) {
                        ...
                        //เอาข้อมูลที่ ดึงมาได้จาก json มาใส่ลงใน recyclerView
    ...
    private EditText alert_snp_com_input_refer;
    ...
    public void onItemClick(int position, String str_partNumber, final String str_snp, String str_ship) {
        ...
        alert_snp_com_bt_cart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (xx < 0) {
                    /* if picker == 0  ถ้าไม่มีการสั่งสินค้า */
                    ...
                    /* if picker != 0 ถ้ามีการสั่งซื้อซื้อค้า */
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    for (int i = 0; i < ja_numResultData.length(); i++) {
                        ...
                        alert_list.add(new DataAlertCom(str_part_sku_code_abt, str_part_usage
                                , str_part_pack, "0", "1", str_part_fg_code_gdj));
                    }
